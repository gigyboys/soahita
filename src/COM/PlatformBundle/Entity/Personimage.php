 ...
 * Personimage
 *
 * @ORM\Table(name="pm_personimage")
 * @ORM\Entity(repositoryClass="COM\PlatformBundle\Entity\PersonimageRepository")
...
class Personimage
{
    ...
    /**
    * @ORM\ManyToOne(targetEntity="COM\PlatformBundle\Entity\Person")
    ...
    */
    ...
    public function preUpload()
    {
        if (null !== $this->file) {
            ...
            $this->path = substr(sha1(uniqid(mt_rand(), true)), 0, 15).'_'.$this->person->getId().'_'.$t.'.'.$this->file->guessExtension();
     ...
     * @return Personimage
     */
    public function setPerson(\COM\PlatformBundle\Entity\Person $person)
    {
        $this->person = $person;
